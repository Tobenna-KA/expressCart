...
function initDb(dbUrl, callback){ // eslint-disable-line
    ...
    MongoClient.connect('mongodb+srv://apucelle_admin:Brain04Child@apucelle.0ytof.mongodb.net:/ml-hair', { useNewUrlParser: true, useUnifiedTopology: true }, connected);
    function connected(err, client){
        ...
        db.emailList = db.collection('emailList');
