...
const createOrder = async (req, res) => {
  ...
  try{
    const orderDoc = {
      ...
      orderPaymentGateway: 'Mpesa-express',
      currency: 'KES',
  ...
  request(
      {
        ...
        json : {
          ...
          "ValidationURL": process.env.MPESA_CONFIRMATION_URL
        }
      },
      function (error, response, body) {
        ...
        console.log('###############')
        if (body.errorCode) {
          req.failedToAddRedirectUrl = true;
        }
...
function simulateC2B (req, res, next) {
  ...
  request(
      {
        ...
        json : {
          "Initiator":"254708374149",
          "SecurityCredential":"Safaricom3021#",
          "CommandID":"AccountBalance",
          "PartyA": "603021",
          "IdentifierType":"4",
          "Remarks":"Success remark",
          "QueueTimeOutURL":"https://lit-beach-18208.herokuapp.com/mpesa/confirmation",
          "ResultURL":"https://lit-beach-18208.herokuapp.com/mpesa/confirmation"
        }
      },
      function (error, response, body) {
